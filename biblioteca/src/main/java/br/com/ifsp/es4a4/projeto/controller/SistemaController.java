...
public class SistemaController {
	...
	public Emprestimo emprestarItem(@RequestHeader String Authorization, @PathVariable("item") String tipoItem, @RequestBody(required = false) ItemFiltroDto filtro) {
		return this.sistemaFacade.emprestarItem(Authorization, tipoItem, filtro);
	}
	
	@GetMapping("/reservar/{item}")
	public Reserva reservarItem(@RequestHeader String Authorization, @PathVariable("item") String tipoItem, @RequestBody(required = false) ItemFiltroDto filtro) {
		return this.sistemaFacade.reservarItem(Authorization, tipoItem, filtro);
	}
	
	@GetMapping("/emprestar/{item}/reservado")
	public Emprestimo pegarEmprestadoItemReservado(@RequestHeader(name = "Authorization") String authorization, @PathVariable("item") String tipoItem, @RequestParam(required = false) String name) {
	...
	public ItemAcervo devolverItemEmprestado(@RequestHeader(name = "Authorization") String authorization, @PathVariable("item") String tipoItem, @RequestParam(required = false) String codigoCatalogacao) {
